...
------------------------------------------------
|      Athor     = Mr.404 (KCA - XCODER)       |
|      Update    = 08-January-2019             |
|      TooL Spam = Telpon    		       |
|      GitHub    = -			           |
|      Info      = jangan gunakan buat bngunin pacar :v|
------------------------------------------------
...
echo " \n";
echo "------------------------------------------------|             SPAM by Mr.404 X-Coder            |------------------------------------------------
|      Athor     = Mr.404 (KCA - XCODER        |
|      Update    = 08-January-2019             ||      TooL Spam = Telpon                      |
|      GitHub    = -                           |
|      Info      = Not gunakan to bangunin dia^_^|
------------------------------------------------\n";
echo " \n";
echo " \n";
